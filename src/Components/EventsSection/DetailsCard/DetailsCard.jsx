  ...
  return (
    <Card className='details-card'>
        ...
        <Row style={{marginTop: "20px"}}>
            <Col lg={6}>
                <h5 className='gradient-text'> Speaker </h5>
            ...
            <NavLink to="https://www.meetup.com/aws-cloud-club-panimalar-chennai/events/299954992/" target="_blank" className='view-event-btn'>
                View Event &nbsp;
